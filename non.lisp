...
;(format t "graf ~a ~%" trenutnoStanjeX )
;(stampajTablu trenutnoStanjeX	)
;(stampajTablu mogucestanje	)
;(format t "stanje ~a ~%" mogucestanje)
;(format t " ~a ~%" trenutnoStanjeX)
(stampajTablu trenutnoStanjeX	)
(novo_stanje (car trenutnoStanjeX) (cdr trenutnoStanjeX) 0 0 0)
...
(defun upisiPotez(s)
 ...
 (defun upisiPotezX(s)
	...
	;(stampajPrviRed 0)
	(stampajTablu trenutnoStanjeX)
	(format t "stanje ~a ~%" (novo_stanje (car trenutnoStanjeX) (cdr trenutnoStanjeX) 0 0 0) )
